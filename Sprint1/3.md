...
- 현재 iptalbes 모드로 작동하기 때문에 Random으로 Pod에 트래픽이 분산된다.
  <img src="images/3/3.png" width="100%">
...
- 2개의 pod 추가 생성
  <img src="images/3/4.png" width="100%">
...
- 동작과정
  ...
  ① 업데이트된 새 Pod 생성<br>
  <img src="images/3/6.png" width="100%">

  ② 기존 Pod 중 하나 삭제, 업데이트된 Pod 추가 생성<br>
  <img src="images/3/7.png" width="100%">

  ③ 다시 기존 Pod 하나 삭제<br>
  <img src="images/3/8.png" width="100%">
...
- 동적과정
  ...
  ① 업데이트된 새 Pod 생성<br>
  <img src="images/3/9.png" width="100%">

  ② Pod 오류<br>
  <img src="images/3/10.png" width="100%">

  ③ 계속 재시작 시도
  <img src="images/3/11.png" width="100%">
