...
```
kubectl get pod -n ingress-nginx -o yaml
```
...
```
kubectl get clusterrolebindings ingress-nginx -o yaml
```
...
```
kubectl get svc -n anotherclass-322 portal-3222
kubectl get ingress -n anotherclass-322 portal-3222 -o yaml
kubectl get endpoints -n anotherclass-322 portal-3222 -o yaml
kubectl get endpointslices -n anotherclass-322 portal-3222-<Press Tab> -o yaml
```
...
```
kubectl logs -n ingress-nginx ingress-nginx-controller-<Press Tab> --tail 10
kubectl logs -n ingress-nginx ingress-nginx-controller-<Press Tab> --follow
```